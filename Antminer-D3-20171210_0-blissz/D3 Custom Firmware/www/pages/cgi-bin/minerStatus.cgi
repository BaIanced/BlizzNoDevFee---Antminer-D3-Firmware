					...
					<div class="cbi-section-node">
						<table class="cbi-section-table">
							<tr class="cbi-section-table-titles">
								...
								<th class="cbi-section-table-cell">MH/S(RT)</th>
								<th class="cbi-section-table-cell">MH/S(avg)</th>
...
ant_stats_tmp=`cgminer-api -o stats`
...
if [ "${ant_stats_tmp}" != "Socket connect failed: Connection refused" ]; then
	...
	do
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then		
			...
			ant_freq=${ant_stats_tmp#*frequency1=}
			ant_freq=${ant_freq%%,frequency2=*}
...
###############################################################################################	
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then		
			...
			ant_freq=${ant_stats_tmp#*frequency2=}
			ant_freq=${ant_freq%%,frequency3=*}
...
###############################################################################################
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then		
			...
			ant_freq=${ant_stats_tmp#*frequency3=}
			ant_freq=${ant_freq%%,frequency4=*}
